...
class _ViewProductDetailsState extends State<ViewProductDetails> {
  void _shareItem() {
    final String text = 'Check out this item: ${widget.item.name}\n'
        'Description: ${widget.item.description}\n'
        'Price: \RM${widget.item.price.toStringAsFixed(2)}\n'
        '${widget.item.imageUrl.isNotEmpty ? widget.item.imageUrl : ''}';
    Share.share(text);
  }
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Color.fromARGB(255, 89, 220, 93),
                padding:
